...
class HullWhiteModel:
    def __init__(self):
        ...
        self.a_cmt = 0.1
        self.a_ted = 1.8
        self.time = [i for i in range(1, 11)]
        #self.term_cmt = interpolate.interp1d(self.time, self.spot_curve([0.0312, 0.0320, 0.0325, 0.0328, 0.0333, 0.0337, 0.0340, 0.0343, 0.0345, 0.0347]), 'linear')
        #self.term_ted = interpolate.interp1d(self.time, self.spot_curve([0.0045, 0.0094, 0.0084, 0.0095, 0.0092, 0.0089, 0.0087, 0.0085, 0.0084, 0.0083]), 'linear')
...
if __name__ == '__main__':
    ...
    path_cmt, path_ted = hullwhite.simulate(1000)
